...
| [@ChicagoSid](#chicagosid) | MCL | 3m | ATR 3.7 | ATR 1.9 | OFF | 240 | 72.1% | 1.47 | 17.6% |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | MCL | 3m | ATR 3.7 | ATR 1.9 | OFF | Sun–Fri | 240 | 72.1% | 1.47 | 17.60% |
| 2 | MCL | 3m | ATR 2.9 | ATR 1.2 | OFF | Sun–Fri | 132 | 79.5% | 1.72 | 10.10% |
...
**Notes:**
- **MCL (Aug 6 update)** — Sid published an updated MCL config this week: SL ATR 3.7 / TP ATR 1.9 on 2m chart, 240 trades at 72.1% WR, PF 1.47, +17.6% net. This supersedes the earlier ATR 2.9/1.2 config on 3m. The updated config is running in the LWTG stack as MCL-3m-QCT (paper, started Aug 5 2026).
- **SIL** — No hard SL, B/E at 75% of TP. 26-trade sample is too small to draw conclusions.
- **MCL (original)** — Micro Crude Light. Tick value 00/point (100 barrels × /bin/sh.01/tick × 100 ticks/point). Intraday margin ~00.
...
| 2026-08-06 | MCL updated config added: ATR 3.7 SL / ATR 1.9 TP, 240 trades, +17.6% net (Week of Aug 3–7 report) |
...
### Current Settings (ETH Aug 4, 2026)

> ⚠️ Contracts reduced across the board Aug 4 pending investigation of FFN account drawdown. All configs are Bill-tuned — not Aaron's defaults.

| Field | MNQ-4m-QCT | MGC-2m-QCT | MYM-5m-QCT |
|---|---|---|---|
| Ticker | MNQ | MGC | MYM |
| TF | 4m | 2m | 5m |
| SL | ATR 3.25 | % 0.8 | ATR 2.5 |
| TP | ATR 1.70 | ATR 2.40 | ATR 1.70 |
| Contracts | 2 | 3 | 3 |
| Day Filter | ON — Tue/Wed/Thu/Fri/Sun (no Mon/Sat) | ON — All days | ON — Mon/Wed/Fri/Sun |
| Block Window | None | None | None |
| Breakeven | OFF | OFF | OFF |
...
**Performance (live trades as of Aug 4, 2026):**

| Preset | Period | Trades | WR | PF | Net % | Live P&L |
|---|---|---|---|---|---|---|
| MNQ-4m-QCT | Jun 18 – Aug 4, 2026 | 158 | 77.2% | 1.92 | 11.8% | +$17,900.50 |
| MGC-2m-QCT | Jul 12 – Aug 4, 2026 | 181 | 66.3% | 1.45 | 6.3% | +$23,908.00 |
| MYM-5m-QCT | Jun 15 – Aug 4, 2026 | 118 | 69.5% | 2.10 | 4.8% | +$1,340.00 |

**Notes:**
- MGC uses percent stop (not ATR) — gold's volatility profile requires price-relative stops
- MYM day filter (Mon/Wed/Fri/Sun) is load-bearing — do not remove
- Formal refit cadence: Oct 1, 2026

| Date Updated | Notes |
|---|---|
| 2026-08-04 | Contracts reduced, TP widened on all 3 presets, now LIVE Week 1 |
